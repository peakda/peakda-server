...
@Schema(description = "신고 대상별 집계")
data class ReportTargetSummaryResponse(
    ...
    @field:Schema(description = "최초 신고 시각", example = "2026-07-27T08:00:00Z")
    val firstReportedAt: Instant,

    @field:Schema(description = "최근 신고 시각", example = "2026-07-28T09:30:00Z")
