...
@Schema(description = "스케줄러 잡 실행 상세")
data class SchedulerJobRunDetailResponse(
    ...
    @field:Schema(description = "실패 스택. 상세 응답에서만 제공한다.", nullable = true)
    ...
    companion object {
        fun of(run: SchedulerJobRun): SchedulerJobRunDetailResponse = SchedulerJobRunDetailResponse(
